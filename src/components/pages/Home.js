      ...
      <Grid.Row>
        <Grid.Col md={12} xl={12}>
          <Card>
            ...
            <Card.Body>
              <p>
                PRLint (P-R-Lint) ensures that your pull requests follow specified conventions.
              </p>
              <p>
                ...
                .{" "}PRLint thrives on checking these kinds of conventions.
              </p>
              <p>
                PRLint fetches metadata about pull requests, commits, branches, trees, and passes the
