          ...
          <Grid.Row>
            <Grid.Col md={12} xl={12}>
              <Card>
                ...
                <Card.Body>
                  <p>
                    {value.appName} ensures that your pull requests follow specified conventions.
                  </p>
                  <p>
                    ...
                    .{" "}{value.appName} thrives on checking these kinds of conventions.
                  </p>
                  <p>
                    {value.appName} fetches metadata about pull requests, commits, branches, trees, and passes the
